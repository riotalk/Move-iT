...
class ViewController: UIViewController, UITextFieldDelegate {
    ...
    func displayAlert(title: String, message: String) {
        ...
        var alert = UIAlertController(title: title, message: "Username and password are required", preferredStyle: UIAlertControllerStyle.Alert)
    ...
    @IBAction func toggleSignUpButton(sender: AnyObject) {
        ...
        toggleSignUpBotton.setTitle("Switch to signup", forState: UIControlState.Normal)
        ...
        `switch`.alpha = 0
            ...
            toggleSignUpBotton.setTitle("Switch to login", forState: UIControlState.Normal)
    ...
    @IBOutlet var toggleSignUpBotton: UIButton!    
